...
model_name = "model_28-0.45.h5"
train_eventlog = "../../Camargo/output_files/data/helpdesk/train_log.csv"
test_eventlog = "../../Camargo/output_files/data/helpdesk/test_log.csv"
...
model = load_model('output_files/models/' + eventlog_name + "/" + model_name)
...
# make predictions
with open('output_files/results/suffix_and_remaining_time_%s' % eventlog_name, 'w') as csvfile:
