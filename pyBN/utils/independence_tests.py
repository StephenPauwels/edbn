...
if __name__ == "__main__":
    ...
    data_int = pd.DataFrame({"A": [0,1,2,3], "B": [1,1,2,2], "C": [0,1,0,1]}, columns=["A", "B", "C"])
    print("MI(A) =", mutual_information(data_int[["A"]]))
    print("MI(A,B) =", mutual_information(data_int[["A", "B"]]))
    print("MI(A,BC) =", mutual_information(data_int[["A", "B", "C"]]))
