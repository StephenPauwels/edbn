...
if __name__ == "__main__":
    ...
    for d in ["Helpdesk"]:
        for m in ["SDL"]:
            try:
                test_standard(d, Methods.get_method(m))
                # test_k(d, Methods.get_method(m))
                # test_split(d, Methods.get_method(m))
                # test_filter(d, Methods.get_method(m))
                # test_percentage(d, Methods.get_method(m))
                # test_split_cases(d, Methods.get_method(m))
                # test_end_event(d, Methods.get_method(m))
            except:
                traceback.print_exc()
