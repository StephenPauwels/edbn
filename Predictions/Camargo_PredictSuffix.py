import Camargo.predict_suffix_full as predict
...
testing.append({"folder": "output_run3b/HELPDESK_20000000_2_1_0_1_1/shared_cat","model": "model_rd_100_Nadam_44-0.31.h5"})
...
for test in testing:
    ...
    predict.predict_suffix_full(output_folder, model_file, False)
